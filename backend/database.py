    ...
    with engine.begin() as conn:
        try:
            conn.execute(insert(history_table).values(
                ...
                eps_hist=data.get('eps_hist'),
                eps_actual=data.get('eps_actual'),
                eps_tendencia=data.get('eps_tendencia', ''),
                fcf_hist=data.get('fcf_hist'),
                fcf_actual=data.get('fcf_actual'),
                fcf_tendencia=data.get('fcf_tendencia', ''),
                roic_hist=data.get('roic_hist'),
                roic_actual=data.get('roic_actual'),
                roic_tendencia=data.get('roic_tendencia', ''),
                per_actual=data.get('per_actual'),
                ev_fcf_actual=data.get('ev_fcf_actual'),
                valor_intrinseco_graham=data.get('valor_intrinseco_graham'),
                valor_intrinseco_dcf=data.get('valor_intrinseco_dcf'),
